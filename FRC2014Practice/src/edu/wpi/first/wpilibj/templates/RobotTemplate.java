...
public class RobotTemplate extends SimpleRobot {
    ...
    final int PWM_R_VICTOR = 4; 
    final int PWM_R_VICTOR_2 = 9; 
    final int PWM_R_VICTOR_3 = 10;
    final double DBW = .3;
    final double DRIFT_CONSTANT = .75;
    //Choo-Choo
    ...
    //Safety
    final double CHOO_CHOO_SAFETY = .5;
    ...
    public void autonomous() {
        ...
        if (isAuto){  // If it is the autonomous mode:
            ...
            limitSwitch(); // Monitor the status of the limit switch.
        }
    ...
    public void operatorControl() {
        ...
        while (isOperatorControl() && isEnabled()){ // During the tele-op mode:
            LCDDisplay.println(DriverStationLCD.Line.kUser6, 1, L2.get() + " ");
    ...
    public void arcadeDrive(){
        ...
        //left = left*DRIFT_CONSTANT;
        //right = right*DRIFT_CONSTANT;
        
        // Set the left motors to the left value.  L2 = Left 2, R = Right 1, applies to all underneath.
        L.set(left); 
        L2.set(left);
        R.set(-right);
        R2.set(-right);
